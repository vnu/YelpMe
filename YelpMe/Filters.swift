...
//  YelpMe
//
//  Created by Vinu Charanya on 2/14/16.
...
class Filters{
    ...
    var filterSections = [String: AnyObject]()
    ...
    func sectionAtIndex(index: Int) -> [[String:String]]{
        let filterKey = sectionTitles[index]
        return filterSections[filterKey] as! [[String:String]]
    }
